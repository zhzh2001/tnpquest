...
const std::string prefixes[names] = {"Hawk", "Tangle", "Wild", "Swift", "Rain", "Thorn", "Fuzzy", "Mud", "Loud", "Bramble", "Moss", "Leopard", "Stealth", "Bright", "Running", "Sand", "Dawn", "Ice", "Spotted", "Rock", "Red", "Mouse", "Tiger", "Flower", "Claw", "Blue"};
const std::string suffixes[names] = {"fire", "claw", "talon", "eyes", "fur", "tail", "nose", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire", "fire"};
